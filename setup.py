...
NAME = 'delayed_image'
INIT_PATH = 'delayed_image/__init__.py'
...
if __name__ == '__main__':
    ...
    setupkw['extras_require'] = {
        ...
        'headless': parse_requirements(
            'requirements/headless.txt', versions='loose'
        ),
        ...
        'linting': parse_requirements(
            'requirements/linting.txt', versions='loose'
        ),
    ...
    setupkw['url'] = 'https://gitlab.kitware.com/computer-vision/delayed_image'
    setupkw['description'] = 'The delayed_image module'
